...
#pragma comment(lib , "../APIHook/detours.lib")
...
void Hook()
{
	...
	DetourAttach((void**)&poldHook11, myCreateWindowExW);
...
void UnHook()
{
	...
	DetourDetach((void**)&poldHook11, myCreateWindowExW);
	DetourTransactionCommit();
}
